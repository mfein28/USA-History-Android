...
public class LBJ extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lbj);
        setTitle("Lyndon B. Johnson");
        RelativeLayout gwFocus = (RelativeLayout) findViewById(R.id.lbjCardFocus);
