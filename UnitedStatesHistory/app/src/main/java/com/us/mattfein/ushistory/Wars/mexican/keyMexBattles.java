 ...
 */
public class keyMexBattles extends Fragment {


    public keyMexBattles() {
        // Required empty public constructor
    }


    private static final String API_Key = "AIzaSyCmM2q0r2iKgGfPEkYJ9q1JKWv0BtdKiDg";
    private static String VIDEO_ID = "bNgotEobNOw";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_impressment, container, false);
