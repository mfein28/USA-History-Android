...
public class JQA extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jqa);
        setTitle("John Quincy Adams");
        RelativeLayout gwFocus = (RelativeLayout) findViewById(R.id.jqaCardFocus);
