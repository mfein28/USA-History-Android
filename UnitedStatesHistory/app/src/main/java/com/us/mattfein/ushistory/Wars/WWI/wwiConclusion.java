 ...
 */
public class wwiConclusion extends Fragment {


    public wwiConclusion() {
        // Required empty public constructor
    }


    private static final String API_Key = "AIzaSyCmM2q0r2iKgGfPEkYJ9q1JKWv0BtdKiDg";
    private static String VIDEO_ID = "soFhWkxSZAY";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_fightin_europe, container, false);
