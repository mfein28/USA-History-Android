package com.us.mattfein.ushistory.Wars.Korea;
 ...
 */
public class TwoKoreas extends Fragment {
    ...
    private static String VIDEO_ID = "MEGyRgYJKEY";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_two_koreas, container, false);
