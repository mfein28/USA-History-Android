 ...
 */
public class TreatyParis extends Fragment {
    ...
    private static String VIDEO_ID = "N8xgPHkHHFE";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_cuban_front, container, false);
