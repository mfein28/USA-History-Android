...
public class JMO extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jmo);
        setTitle("James Monroe");
        RelativeLayout gwFocus = (RelativeLayout) findViewById(R.id.jmoCardFocus);
